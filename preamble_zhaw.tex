...
\usepackage[style=apa, backend=biber]{biblatex} %biber als default bibliography tool bestimmen
% BibLaTeX-Bibliografie-Datei einbinden, aus Zotero exportieren und im gleichen Ordner speichern
\addbibresource{Bibliothek.bib}  % Pfad zur BibTeX-Datei
...
\renewcommand{\cftsecfont}{\large} % Sektionen gross
\renewcommand{\cftsubsecfont}{\normalfont} % Subsektionen nicht fett
\renewcommand{\cftsecpagefont}{\large} % Seitenzahlen fett
